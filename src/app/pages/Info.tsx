...
export function Info() {
  ...
  const features = [
    { icon: <EventNote sx={{ color: '#ff4e00' }} />, title: 'Descubra Eventos', desc: 'Encontre apresentações musicais, peças de teatro, festivais, exposições e muito mais.' },
    { icon: <SmartToy sx={{ color: '#ff4e00' }} />, title: 'Chat com Sayd', desc: 'Nosso assistente de IA recomenda eventos personalizados para o seu gosto.' },
    { icon: <LocationOn sx={{ color: '#ff4e00' }} />, title: 'Locais Culturais', desc: 'Explore parques, centros culturais, teatros e galerias da sua cidade.' },
    { icon: <Favorite sx={{ color: '#ff4e00' }} />, title: 'Salve Favoritos', desc: 'Guarde os eventos que você quer ir e acesse facilmente depois.' },
  ];
